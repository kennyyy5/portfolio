  ...
  <div className="font-mono text-lg font-bold mt-2">];</div>
          ...
          <div className="col-span-12 md:col-span-4">
            ...
            <div className="bg-blue p-3 shadow-lg mb-4 transform rotate-2 relative font-mono">
              ...
              <img className="w-full bg-gray-800 flex items-center justify-center text-7xl border-2 border-green-500 transition-opacity hover:opacity-90" src='img-of-me.png'/>
